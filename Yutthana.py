...
df = pd.read_excel("Book1.xlsx", sheet_name="Moshi", skiprows=1)
df.columns = [
...
st.title("Moshi") 
st.write("บริษัท โมชิ โมชิ รีเทล คอร์ปอเรชั่น จำกัด (มหาชน)")
...
ax.set_title("Moshi Closing Price Trend")
ax.set_xlabel("Date")
...
st.pyplot(fig)
st.write("ข้อมูลล่าสุดเมื่อวันที่ 23 พฤษภาคม พ.ศ.2568")